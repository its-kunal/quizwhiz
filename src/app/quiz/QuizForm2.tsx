  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 transition-colors">
        <div className="p-6">
          <h1 className="text-2xl font-medium text-gray-800 dark:text-gray-100 mb-1">Create Quiz</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Fill in the details below to generate your quiz</p>
